...
class UsuarioManager(BaseUserManager):
    def create_user(self, email, nombres, apellidos, rut, telefono, password=None, usuario_tipo='cliente', numero_medidor=None, consumo=None):
...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    consumo = models.DecimalField('Consumo', max_digits=10, decimal_places=2, blank=True, null=True)
